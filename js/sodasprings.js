const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=aee52151b6cc7c7556030fdb68db7347";
fetch(apiURL)
...
const apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=aee52151b6cc7c7556030fdb68db7347";
fetch(apiURL2)
  .then((response) => response.json())
  .then((jsObject2) => {
